    ...
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @endcan
                @can('inpatient_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/inpatients*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.inpatients.index") }}">
                            <i class="fa-fw c-sidebar-nav-icon fas fa-angle-double-left">
                            </i>
                            {{ trans('cruds.inpatient.title') }}
                        </a>
                    </li>
                @endcan
                @can('outpatient_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/outpatients*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.outpatients.index") }}">
                            <i class="fa-fw c-sidebar-nav-icon fas fa-angle-double-right">
                            </i>
                            {{ trans('cruds.outpatient.title') }}
                        </a>
                    </li>
                @endcan
                @can('room_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/rooms*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.rooms.index") }}">
                            <i class="fa-fw c-sidebar-nav-icon fas fa-door-open">
                            </i>
                ...
                @can('doctor_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/doctors*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.doctors.index") }}">
                ...
                @can('lab_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/labs*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.labs.index") }}">
                            <i class="fa-fw c-sidebar-nav-icon fas fa-flask">
                            </i>
                            {{ trans('cruds.lab.title') }}
                        </a>
                    </li>
                @endcan
               
                <li class="items-center">
                <a class= "sidebar-nav" href="http://localhost:8501" target="_blank">
